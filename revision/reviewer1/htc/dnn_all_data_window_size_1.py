...
def build_model():
    ...
    # b = Conv1D(64, kernel_size=3, activation='relu')(b)
    # b = MaxPooling1D(2)(b)
    #
    ...
    # c = Conv1D(64, kernel_size=3, activation='relu')(c)
    # c = MaxPooling1D(2)(c)
