...
def build_model():
    ...
    lstm = LSTM(128, input_shape=(450, 10), activation='tanh', dropout=0.2, recurrent_dropout=0.2)(all_inputs)

    fully_connect = Dense(128, activation='relu', kernel_initializer='truncated_normal')(lstm)
    fully_connect = Dropout(0.2)(fully_connect)
    fully_connect = Dense(256, activation='relu', kernel_initializer='truncated_normal')(fully_connect)
    fully_connect = Dropout(0.2)(fully_connect)
    fully_connect = Dense(512, activation='relu', kernel_initializer='truncated_normal')(fully_connect)
    fully_connect = Dropout(0.2)(fully_connect)
    fully_connect = Dense(1024, activation='relu', kernel_initializer='truncated_normal')(fully_connect)
    fully_connect = Dropout(0.2)(fully_connect)

    output = Dense(num_classes, activation='softmax', name='output')(fully_connect)
