...
train_data = np.load("/public/lhy/data/npz/all_data_train_0.8_window_450_no_his_no_smooth.npz")
test_data = np.load("/public/lhy/data/npz/all_data_test_0.2_window_450_no_his_no_smooth.npz")
